...
class Base64Encoder {
   public:
    ...
    static std::vector<unsigned char> decode_data(const std::string& encoded_data);
    static std::vector<unsigned char> decode_data(const char* encoded_data, size_t length);
