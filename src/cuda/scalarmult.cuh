...
// table[i][j] = j * bases[i] in Niels form, for entry id = i * kStride + j
...
// r = s * B for s < 2^255, using signed fixed-window digits and the table.
__device__ __forceinline__ void
